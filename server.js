...
wss.on('connection', (ws) => {
    ...
    ws.on('message', async (message) => {
        ...
        if (data.type === 'HOST_ROOM') {
            ...
            // Server-side YouTube search resolver for song names
            try {
                ...
                ws.send(JSON.stringify({ type: 'NOTIFICATION', message: 'AI could not find song.' }));
            }
        }
        else {
...
console.log('SyncBeat WebSocket Server Running with YouTube Search Support...');
